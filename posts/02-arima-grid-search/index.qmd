...
subtitle: 'Basics of grid search for ARIMA with plots in R'
date: "2025-09-27"
categories: [R, time-series, machine-learning, grid-search]
image: "image.png"
# navbar: true
format:
  html:
...
filters: 
    - social-share
share:
  permalink: "https://joshuamarie.com/posts/02-arima-grid-search/"
  description: "Arima Grid Search in R - Joshua Marie"
  twitter: true
  facebook: true
  reddit: true
  stumble: true
...
```{r setup-html, include=FALSE, eval=FALSE}
#| include: false
knit_print_test = function(x, options) {
    # Don't intercept data frames, tibbles, or kable outputs
    if (inherits(x, c("data.frame", "tbl_df", "tbl", "knitr_kable"))) {
